...
<body>
		...
		<div class="container">
		    <form action="" method="post" id="self_introduce_form">
		        <div class="form-group">
		            ...
		            <input id="subject" type="text" name="subject" value="${selfIntroduce.subject}">
		        </div>
		        <div class="form-group">
		            ...
		            <div class="input_deco_input_content">
		                <textarea id="content" type="text" name="content"><%= selfIntroduce.getContent() %></textarea>
		            </div>
		        </div>
		        <div>
    ...
    <script src="/bysl/resources/javascript/selfIntroduce/update.js"></script>
</body>
</html>