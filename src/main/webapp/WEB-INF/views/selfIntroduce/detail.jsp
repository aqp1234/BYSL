...
<%@page import="com.kms.bysl.dto.SelfIntroduceCommentDTO"%>
...
<%
	...
	SelfIntroduceDTO selfIntroduce = (SelfIntroduceDTO) request.getAttribute("selfIntroduce");
	List<SelfIntroduceCommentDTO> comments = (List<SelfIntroduceCommentDTO>) request.getAttribute("comments");
...
<body>
    ...
    <section id="main" class="workspace_section">
    	<% if (selfIntroduce.getOwnerId() == member.getId()) { %>
		<div id="top_detail">
		    <a href='/bysl/solo/selfIntroduce/<%= soloWorkspace.getId() %>' id='exit-btn'>◀</a>
		    <div style="display: flex;">
		        <span class="text_deco11_student"><a href='#' onclick="openInvitePage()" class="text_deco12" id="staffinvitebtn" data-type="selfintro">글 공유</a></span>
		        <span class="text_deco11_student"><a href='#' onclick="deletethis()" class="text_deco12">글 삭제</a></span>
		        <span class="text_deco11_student"><a href='/bysl/solo/selfIntroduce/<%= soloWorkspace.getId() %>/update/<%= selfIntroduce.getId() %>' class="text_deco12">글 수정</a></span>
		    </div>
		</div>
		<% } %>
		...
		<div id="detail_top">
		    <div class="detail_title_selfintroduce"><%= selfIntroduce.getSubject() %></div>
		</div>
		
		</div>
		<div readonly id="detail_body"></div>
		<div style="margin-left: 10px;"><hr size="3" noshade color="FDECB8" style="margin-top: 20px;"/></div>
		
		<div id="comment_box">
		    <div class="comments">Comments</div>
		        <div class="mt-3 border-bottom">
		            <% for (SelfIntroduceCommentDTO comment : comments) { %>
		                    ...
		                    <div class="row">
		                        ...
		                        <div class="col-9 col-md-10 col-lg-11" style="width: 100%;">
		                            <div class="comment-show" id="comment-show">
		                                ...
		                                <div class="comment_edit" style="display: none" id="comment_edit_<%= comment.getId() %>">
		                                    <div class="mt-3">
    ...
    <script src="/bysl/resources/javascript/selfIntroduce/detail.js"></script>
